...
export const useStyles = makeStyles((theme) => ({
  root: {
    ...
    // backgroundRepeat:'repeat',https://png.pngtree.com/thumb_back/fh260/background/20191113/pngtree-pattern-design-blue-dark-gradient-texture-background-image_322118.jpg
    // backgroundPosition: '0% -30%',
    // https://www.freepik.com/free-vector/golden-arabesque-arabis-style-islamic-pattern-background_8998511.htm#page=1&query=islamic%20background&position=3
